...
const description = `$${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. As of now, ${numUnfunded} ${numUnfunded === 1 ? 'game remains unfunded' : 'games remain unfunded :('}`;
...
// create a new element to hold the name of the top pledge game, then append it to the correct elemen
...
runnerUpGameElem.innerHTML = runnerUpGame.name;
